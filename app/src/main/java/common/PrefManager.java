...
public class PrefManager {
    ...
    // shared pref mode
    int PRIVATE_MODE = 0;
    private static final String PREF_NAME = "MotzApp";
    private static final String LoggedIn = "MotzAppLoggedIn";
    private static final String FcmToken = "MotzAppFcmToken";
    private static final String UserToken = "MotzAppUSerToken";
